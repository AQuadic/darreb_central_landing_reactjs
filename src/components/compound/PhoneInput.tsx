    ...
    return (
      <div className={cn("relative w-full", className)} dir="ltr">
        ...
        {isOpen && (
          <div
            ref={dropdownRef}
            className="absolute top-full left-0 right-0 z-99 mt-2 rounded-md border border-input text-popover-foreground shadow-md max-h-60 overflow-hidden bg-white"
            dir="ltr"
          >
            {/* Search input */}
